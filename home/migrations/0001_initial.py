# Generated by Django 5.0.6 on 2024-11-14 14:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('colors', models.ManyToManyField(blank=True, to='home.color')),
            ],
        ),
        migrations.CreateModel(
            name='BasketItem',
            fields=[
                ...
                ('color', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='home.color')),
